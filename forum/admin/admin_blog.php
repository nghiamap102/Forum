		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
											...
											<div class="box-wrapper">
												...
												<div class="box-body mb-2">	
													<div class="form-group">
														...
														<input type="text" name="" value="admin" id="user2" disabled class="form-control">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="active" class="font-20"  style="font-weight: 600;">Active</label>
														<input type="checkbox" name="" value="" id="active">
													</div>
												</div>
					...
					<input type="button" class="btn btn-primary mt-2 garbage" value="ADD BLOG" />
					<div class="modal-confirm">
						<div class="model-box">
							<div class="box-wrapper">
								<h3 class="box-header">
